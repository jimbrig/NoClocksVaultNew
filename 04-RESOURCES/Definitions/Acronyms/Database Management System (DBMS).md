...
description: Software enabling the creation, management, and manipulation of databases.
tags:
  - Status/Complete
  - Topic/GIS
...
**Relational DBMS** organizes data in tables with rows and columns (PostgreSQL, SQL Server).
**Spatial extension** adds geometry types and spatial functions to a DBMS (PostGIS, SQL Server Spatial).
**Spatial index** enables fast retrieval of features by location (R-tree, quadtree).
...
| DBMS | Spatial Extension | License |
|------|------------------|---------|
| PostgreSQL | PostGIS | Open source |
| SQL Server | Spatial | Commercial |
| MySQL | Spatial | Open source |
| Oracle | Spatial | Commercial |
| SQLite | SpatiaLite | Open source |
