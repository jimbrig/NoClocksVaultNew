...
|--------|--------|---------------|----------|
| [[04-RESOURCES/Integrations/Chats/_README\|Chats/]] | AI LLMs (Perplexity, ChatGPT, Claude) | Nexus AI Chat Importer, manual | `Template-AIChat.md` |
| [[04-RESOURCES/Integrations/Clippings/_README\|Clippings/]] | Web pages | Obsidian Web Clipper | Browser extension |
| [[04-RESOURCES/Integrations/Medium/_README\|Medium/]] | Medium articles | Medium Importer | Plugin |
| [[04-RESOURCES/Integrations/Raindrop/_README\|Raindrop/]] | Raindrop.io bookmarks | Raindrop sync | Plugin |
| [[04-RESOURCES/Integrations/Readwise/_README\|Readwise/]] | Kindle, articles, tweets | Readwise Official | Plugin |
| [[04-RESOURCES/Integrations/Zotero/_README\|Zotero/]] | Academic papers | Zotero Integration | Plugin |
| [[04-RESOURCES/Integrations/Embeds/_README\|Embeds/]] | Embedded widgets | Manual | Various |
...
FROM "04-RESOURCES/Integrations"
...
- [[00-INBOX/_README|Inbox]] (for manual quick capture)

### Backlinks

```dataview
LIST FROM [[_README]] AND -"CHANGELOG" AND -"04-RESOURCES/Integrations/_README"
```
