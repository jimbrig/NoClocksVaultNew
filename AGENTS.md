...
|----------|---------------|----------|
| AI Chat Processing | [04-RESOURCES/Guides/Guide - AI Chat Processing Workflow](04-RESOURCES/Guides/Guide - AI Chat Processing Workflow.md) | `.cursor/commands/process-ai-chat.md` |
| Inbox Processing | [04-RESOURCES/Guides/Guide - Inbox Processing](04-RESOURCES/Guides/Guide - Inbox Processing.md) | `.cursor/commands/process-inbox.md` |
| Quartz Publishing | [05-SYSTEM/Meta/QUARTZ](05-SYSTEM/Meta/QUARTZ.md) | `.cursor/commands/launch-quartz.md` |
| Vault Auditing | [05-SYSTEM/Audit/README](05-SYSTEM/Audit/README.md) | `.cursor/commands/audit-*.md` |
