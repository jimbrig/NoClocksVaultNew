...
description: Standards development organizations for geospatial data and services
tags:
  - Status/Ongoing
  - Type/List
  - Topic/GIS
...
| Organization | Acronym | Description | Links |
|--------------|---------|-------------|-------|
| Real Estate Standards Organization | RESO | Real estate data standards | [Website](https://reso.org) - [04-RESOURCES/Definitions/Acronyms/Real Estate Standards Organization (RESO)](04-RESOURCES/Definitions/Acronyms/Real Estate Standards Organization (RESO).md) |
...
| Organization | Acronym | Description | Links |
|--------------|---------|-------------|-------|
| World Wide Web Consortium | W3C | Web standards including spatial data on the web | [Website](https://w3.org/groups/ig/sdw/) |
| IETF | IETF | GeoJSON RFC 7946 | [RFC 7946](https://tools.ietf.org/html/rfc7946) |

---

## OGC Standards Reference

### Modern OGC APIs

| Standard | Description | Docs |
|----------|-------------|------|
| OGC API - Common | Foundation for OGC APIs | [Spec](https://ogc.org/standards/ogcapi-common/) |
| OGC API - Features | Vector feature access (replaces WFS) | [Spec](https://ogc.org/standards/ogcapi-features/) |
| OGC API - Tiles | Map tile access (replaces WMTS) | [Spec](https://ogc.org/standards/ogcapi-tiles/) |
| OGC API - Maps | Map image access | [Spec](https://ogc.org/standards/ogcapi-maps/) |
| OGC API - Processes | Processing services (replaces WPS) | [Spec](https://ogc.org/standards/ogcapi-processes/) |
| OGC API - Records | Catalog services (replaces CSW) | [Spec](https://ogc.org/standards/ogcapi-records/) |
| OGC API - EDR | Environmental data retrieval | [Spec](https://ogc.org/standards/ogcapi-edr/) |

### Legacy OGC Web Services
...
| Catalogue Service for Web | CSW | Metadata discovery | [Spec](https://ogc.org/standards/cat/) |

### OGC Data Formats

| Standard | Description | Links |
|----------|-------------|-------|
| GeoPackage | SQLite-based vector/raster container | [Spec](https://ogc.org/standards/geopackage/) |
| GeoJSON | JSON geometry encoding | [RFC 7946](https://tools.ietf.org/html/rfc7946) |
