# Vault Plugins
 ...
 > [!NOTE]
 > *This document's table is automatically generated using the *PowerShell Code* Scripts from: *PowerShell - Get-ObsidianPlugins**
...
|Copilot|3.1.4|Your AI Copilot: Chat with Your Second Brain, Learn Faster, Work Smarter.|
...
|File Hider|1.1.1|An Obsidian plugin that allows hiding files and folders in the built-in file explorer|
|Find orphaned files and broken links|1.10.1|Find files that are not linked anywhere and would otherwise be lost in your vault. In other words: files with no backlinks.|
...
|GitHub Copilot|1.1.9|Implement GitHub Copilot services (suggestion and chat) in Obsidian|
|Google Calendar and Contacts Lookup|1.7.0|Import contact and calendar event information from your Google account|
...
|Leaflet|6.0.5|Interactive maps inside your notes|
...
|Metadata Menu|0.8.11|For data quality enthusiasts (and dataview users): manage the metadata of your notes.|
...
|QuickAdd|2.9.4|Quickly add new pages or content to your vault.|
...
|Recent Files|1.7.5|List files by most recently opened|
|Settings Search|1.3.10|Globally search settings in Obsidian.md|
|Smart Connections|4.1.4|Chat with your notes & see links to related content with Local or Remote models.|
...
|Templater|2.16.4|Create and use templates|
|Terminal|3.20.0|Integrate consoles, shells, and terminals.|
|Todoist Sync|2.3.0|Materialize Todoist tasks within Obsidian notes.|
...
*Note created on [2025-12-22](02-JOURNAL\2025\12-December\2025-12-22.md) and last modified on [2025-12-22](02-JOURNAL\2025\12-December\2025-12-22.md).*
...
<!-- dataview query removed for github compatibility -->
