...
aliases:
  ...
  - Clean node_modules
description: PowerShell command to recursively remove node_modules folders to free disk space
cssclasses:
  - code
---
...
> [!SOURCE] Sources:
> - *[Remove node_modules folders in Windows recursively](https://gist.github.com/SynCap/3dded8070dce3013fdc3fd4f95383651)*
...
```dataview
LIST FROM [[PowerShell - Remove node_modules Folders Recursively]] AND -"CHANGELOG"
```
