...
description: The visual representation of spatial features using colors, symbols, and styles.
tags:
  - Status/Complete
  - Topic/GIS
  - Type/Definition
...
**Symbol** is a graphic element (marker, line, fill) representing a feature.
**Color ramp** is a gradient of colors representing a range of values.
**Classification** groups features into categories for distinct symbols.
**Transparency/Opacity** controls how much underlying features show through.
**Labeling** displays text annotations from feature attributes.
**Legend** explains the meaning of symbols on a map.
